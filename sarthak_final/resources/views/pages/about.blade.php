...
@section('main-section')
        ...
        <div class="container g-0 line">
            ...
            <div class="col-xxl-12">
                ...
                <div class="hero__about-info">
                    ...
                    <div class="btn_wrapper">
                        <a href="{{url('/services')}}" class="wc-btn-primary btn-hover btn-item"><span></span> Trends & <br>
                        technology
                    ...
                    <img src="{{url('assets/imgs/about/award.png')}}" alt="Best Studio Award">
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="col-xxl-12">
                ...
                <video loop="" muted="" autoplay="" playsinline="">
                    <source src="{{url('assets/video/video.mp4')}}" type="video/mp4">
                </video>
                </div>
            </div>
            </div>
        ...
        <div class="container g-0 line pt-140">
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                ...
                <img src="{{url('assets/imgs/story/1.jpg')}}" alt="Story Thumbnail" class="w-100">
                </div>
            </div>
            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                <div class="story__img-wrapper img-anim">
                <img src="{{url('assets/imgs/story/2.jpg')}}" alt="Story Thumbnail" data-speed="auto">
                </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <div class="story__img-wrapper">
                <img src="{{url('assets/imgs/story/3.jpg')}}" alt="Story Thumbnail">
                <img src="{{url('assets/imgs/story/4.jpg')}}" alt="Story Thumbnail">
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="swiper team__slider">
            ...
            <div class="swiper-slide team__slide">
                ...
                <img src="{{url('assets/imgs/team/1.jpg')}}" alt="Team Member">
            ...
            <div class="swiper-slide team__slide">
                <a href="team-details.html">
                <img src="{{url('assets/imgs/team/2.jpg')}}" alt="Team Member">
                <div class="team__info">
            ...
            <div class="swiper-slide team__slide">
                <a href="team-details.html">
                <img src="{{url('assets/imgs/team/3.jpg')}}" alt="Team Member">
                <div class="team__info">
            ...
            <div class="swiper-slide team__slide">
                <a href="team-details.html">
                <img src="{{url('assets/imgs/team/4.jpg')}}" alt="Team Member">
                <div class="team__info">
        ...
        <div class="container g-0 line pb-140">
            ...
            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                ...
                <video autoplay="" muted="" loop="">
                    <source src="{{url('assets/video/testimonial.mp4')}}" type="video/mp4">
                </video>
                </div>
            </div>
        ...
        <div class="container line pb-110 dark-p">
            ...
            <div class="col-xxl-12">
                ...
                <div class="btn_wrapper">
                    <a href="{{url('/contact')}}" class="wc-btn-primary btn-hover btn-item"><span></span>Let’s talk us <i class="fa-solid fa-arrow-right"></i></a>
                </div>
                </div>
            </div>
            </div>
