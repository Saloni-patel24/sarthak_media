...
@push('title')
    <title>Blog Details - Sarthak Media</title>
@endpush
@section('main-section')
                ...
                <div class="container g-0 line pt-130 pb-140">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                        ...
                        <h5><a href="{{url('/blog-details')}}" class="blog__title sub-title-anim">Ways of lying to yourself about
                            your new
                            relationship.</a></h5>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                        ...
                        <h4 class="blog__meta sub-title-anim"><a href="category.html">UI Design</a> . 02 May 2019</h4>
                        <h5><a href="{{url('/blog-details')}}" class="blog__title sub-title-anim">How to manage a talented and
                            successful de sign
                            team</a></h5>
                        <a href="{{url('/blog-details')}}" class="blog__btn">Read More <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </article>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                        ...
                        <h4 class="blog__meta sub-title-anim"><a href="category.html">UI Design</a> . 02 May 2019</h4>
                        <h5><a href="{{url('/blog-details')}}" class="blog__title sub-title-anim">How to bring fold to your
                            startup
                            company with
                            Axtra</a></h5>
                        <a href="{{url('/blog-details')}}" class="blog__btn">Read More <span><i class="fa-solid fa-arrow-right"></i></span></a>
